...
const CalendarRow: React.FC<CalendarRowProps> = ({ currentDate = new Date() }) => {
            ...
            {days.map((day, index) => (
                <div
                    ...
                    className={`w-16 h-20 flex flex-col cursor-pointer hover:translate-y-[-5px] duration-300 items-center justify-center rounded-[40px] ${
                        day.isSame(today, "day") ? "bg-neutral-100 text-gray-900 font-bold" : "bg-neutral-50 text-gray-700"
                    }`}
                >
